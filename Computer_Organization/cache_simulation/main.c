...
int main(void) {
    ...
    if(new_cache.mapping_fun==1)
		direct_mapping(&new_cache);

	else if (new_cache.mapping_fun==2)
    	full_mapping(&new_cache);

    else if (new_cache.mapping_fun==3)
        set_mapping(&new_cache);
